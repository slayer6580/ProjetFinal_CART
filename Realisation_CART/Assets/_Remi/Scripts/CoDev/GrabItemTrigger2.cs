...
namespace BoxSystem
{
    public class GrabItemTrigger2 : MonoBehaviour
    {
        ...
        private List<Shelf2> m_takableShelves = new List<Shelf2>();
        private Shelf2 m_choosenShelf = null;
        ...
        {
            Shelf2 shelf = other.GetComponent<Shelf2>();
        ...
        private void UpdateBestShelfOption()
        {
            ...
            Shelf2 closestShelf = null;

            foreach (Shelf2 shelf in m_takableShelves)
            {
        ...
        public void TakeItemFromShelf()
        {
            ...
            ItemData.ESize size = itemTaken.GetComponent<Item2>().m_data.m_size; 
        ...
        public bool IsThereShelfInList()
        {
            return m_takableShelves.Count > 0;
        }
    }
}
